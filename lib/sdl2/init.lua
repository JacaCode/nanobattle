...
register('SCANCODE_EJECT', 'SDL_SCANCODE_EJECT')
register('SCANCODE_SLEEP', 'SDL_SCANCODE_SLEEP')
register('K_UNKNOWN', 'SDLK_UNKNOWN')
register('K_RETURN', 'SDLK_RETURN')
register('K_ESCAPE', 'SDLK_ESCAPE')
register('K_BACKSPACE', 'SDLK_BACKSPACE')
register('K_TAB', 'SDLK_TAB')
register('K_SPACE', 'SDLK_SPACE')
register('K_EXCLAIM', 'SDLK_EXCLAIM')
register('K_QUOTEDBL', 'SDLK_QUOTEDBL')
register('K_HASH', 'SDLK_HASH')
register('K_PERCENT', 'SDLK_PERCENT')
register('K_DOLLAR', 'SDLK_DOLLAR')
register('K_AMPERSAND', 'SDLK_AMPERSAND')
register('K_QUOTE', 'SDLK_QUOTE')
register('K_LEFTPAREN', 'SDLK_LEFTPAREN')
register('K_RIGHTPAREN', 'SDLK_RIGHTPAREN')
register('K_ASTERISK', 'SDLK_ASTERISK')
register('K_PLUS', 'SDLK_PLUS')
register('K_COMMA', 'SDLK_COMMA')
register('K_MINUS', 'SDLK_MINUS')
register('K_PERIOD', 'SDLK_PERIOD')
register('K_SLASH', 'SDLK_SLASH')
register('K_0', 'SDLK_0')
register('K_1', 'SDLK_1')
register('K_2', 'SDLK_2')
register('K_3', 'SDLK_3')
...
register('K_8', 'SDLK_8')
register('K_9', 'SDLK_9')
register('K_COLON', 'SDLK_COLON')
register('K_SEMICOLON', 'SDLK_SEMICOLON')
register('K_LESS', 'SDLK_LESS')
register('K_EQUALS', 'SDLK_EQUALS')
register('K_GREATER', 'SDLK_GREATER')
register('K_QUESTION', 'SDLK_QUESTION')
register('K_AT', 'SDLK_AT')
register('K_LEFTBRACKET', 'SDLK_LEFTBRACKET')
register('K_BACKSLASH', 'SDLK_BACKSLASH')
register('K_RIGHTBRACKET', 'SDLK_RIGHTBRACKET')
register('K_CARET', 'SDLK_CARET')
register('K_UNDERSCORE', 'SDLK_UNDERSCORE')
register('K_BACKQUOTE', 'SDLK_BACKQUOTE')
register('K_a', 'SDLK_a')
register('K_b', 'SDLK_b')
register('K_c', 'SDLK_c')
register('K_d', 'SDLK_d')
...
register('K_y', 'SDLK_y')
register('K_z', 'SDLK_z')
register('K_CAPSLOCK', 'SDLK_CAPSLOCK')
register('K_F1', 'SDLK_F1')
register('K_F2', 'SDLK_F2')
register('K_F3', 'SDLK_F3')
register('K_F4', 'SDLK_F4')
register('K_F5', 'SDLK_F5')
register('K_F6', 'SDLK_F6')
register('K_F7', 'SDLK_F7')
register('K_F8', 'SDLK_F8')
register('K_F9', 'SDLK_F9')
register('K_F10', 'SDLK_F10')
register('K_F11', 'SDLK_F11')
register('K_F12', 'SDLK_F12')
register('K_PRINTSCREEN', 'SDLK_PRINTSCREEN')
register('K_SCROLLLOCK', 'SDLK_SCROLLLOCK')
register('K_PAUSE', 'SDLK_PAUSE')
register('K_INSERT', 'SDLK_INSERT')
register('K_HOME', 'SDLK_HOME')
register('K_PAGEUP', 'SDLK_PAGEUP')
register('K_DELETE', 'SDLK_DELETE')
register('K_END', 'SDLK_END')
register('K_PAGEDOWN', 'SDLK_PAGEDOWN')
register('K_RIGHT', 'SDLK_RIGHT')
register('K_LEFT', 'SDLK_LEFT')
register('K_DOWN', 'SDLK_DOWN')
register('K_UP', 'SDLK_UP')
register('K_NUMLOCKCLEAR', 'SDLK_NUMLOCKCLEAR')
register('K_KP_DIVIDE', 'SDLK_KP_DIVIDE')
register('K_KP_MULTIPLY', 'SDLK_KP_MULTIPLY')
register('K_KP_MINUS', 'SDLK_KP_MINUS')
register('K_KP_PLUS', 'SDLK_KP_PLUS')
register('K_KP_ENTER', 'SDLK_KP_ENTER')
register('K_KP_1', 'SDLK_KP_1')
register('K_KP_2', 'SDLK_KP_2')
register('K_KP_3', 'SDLK_KP_3')
register('K_KP_4', 'SDLK_KP_4')
register('K_KP_5', 'SDLK_KP_5')
register('K_KP_6', 'SDLK_KP_6')
register('K_KP_7', 'SDLK_KP_7')
register('K_KP_8', 'SDLK_KP_8')
register('K_KP_9', 'SDLK_KP_9')
register('K_KP_0', 'SDLK_KP_0')
register('K_KP_PERIOD', 'SDLK_KP_PERIOD')
register('K_APPLICATION', 'SDLK_APPLICATION')
register('K_POWER', 'SDLK_POWER')
register('K_KP_EQUALS', 'SDLK_KP_EQUALS')
register('K_F13', 'SDLK_F13')
register('K_F14', 'SDLK_F14')
register('K_F15', 'SDLK_F15')
register('K_F16', 'SDLK_F16')
register('K_F17', 'SDLK_F17')
register('K_F18', 'SDLK_F18')
register('K_F19', 'SDLK_F19')
register('K_F20', 'SDLK_F20')
register('K_F21', 'SDLK_F21')
register('K_F22', 'SDLK_F22')
register('K_F23', 'SDLK_F23')
register('K_F24', 'SDLK_F24')
register('K_EXECUTE', 'SDLK_EXECUTE')
register('K_HELP', 'SDLK_HELP')
register('K_MENU', 'SDLK_MENU')
register('K_SELECT', 'SDLK_SELECT')
register('K_STOP', 'SDLK_STOP')
register('K_AGAIN', 'SDLK_AGAIN')
register('K_UNDO', 'SDLK_UNDO')
register('K_CUT', 'SDLK_CUT')
register('K_COPY', 'SDLK_COPY')
register('K_PASTE', 'SDLK_PASTE')
register('K_FIND', 'SDLK_FIND')
register('K_MUTE', 'SDLK_MUTE')
register('K_VOLUMEUP', 'SDLK_VOLUMEUP')
register('K_VOLUMEDOWN', 'SDLK_VOLUMEDOWN')
register('K_KP_COMMA', 'SDLK_KP_COMMA')
register('K_KP_EQUALSAS400', 'SDLK_KP_EQUALSAS400')
register('K_ALTERASE', 'SDLK_ALTERASE')
register('K_SYSREQ', 'SDLK_SYSREQ')
register('K_CANCEL', 'SDLK_CANCEL')
register('K_CLEAR', 'SDLK_CLEAR')
register('K_PRIOR', 'SDLK_PRIOR')
register('K_RETURN2', 'SDLK_RETURN2')
register('K_SEPARATOR', 'SDLK_SEPARATOR')
register('K_OUT', 'SDLK_OUT')
register('K_OPER', 'SDLK_OPER')
register('K_CLEARAGAIN', 'SDLK_CLEARAGAIN')
register('K_CRSEL', 'SDLK_CRSEL')
register('K_EXSEL', 'SDLK_EXSEL')
register('K_KP_00', 'SDLK_KP_00')
register('K_KP_000', 'SDLK_KP_000')
register('K_THOUSANDSSEPARATOR', 'SDLK_THOUSANDSSEPARATOR')
register('K_DECIMALSEPARATOR', 'SDLK_DECIMALSEPARATOR')
register('K_CURRENCYUNIT', 'SDLK_CURRENCYUNIT')
register('K_CURRENCYSUBUNIT', 'SDLK_CURRENCYSUBUNIT')
register('K_KP_LEFTPAREN', 'SDLK_KP_LEFTPAREN')
register('K_KP_RIGHTPAREN', 'SDLK_KP_RIGHTPAREN')
register('K_KP_LEFTBRACE', 'SDLK_KP_LEFTBRACE')
register('K_KP_RIGHTBRACE', 'SDLK_KP_RIGHTBRACE')
register('K_KP_TAB', 'SDLK_KP_TAB')
register('K_KP_BACKSPACE', 'SDLK_KP_BACKSPACE')
register('K_KP_A', 'SDLK_KP_A')
register('K_KP_B', 'SDLK_KP_B')
register('K_KP_C', 'SDLK_KP_C')
register('K_KP_D', 'SDLK_KP_D')
register('K_KP_E', 'SDLK_KP_E')
register('K_KP_F', 'SDLK_KP_F')
register('K_KP_XOR', 'SDLK_KP_XOR')
register('K_KP_POWER', 'SDLK_KP_POWER')
register('K_KP_PERCENT', 'SDLK_KP_PERCENT')
register('K_KP_LESS', 'SDLK_KP_LESS')
register('K_KP_GREATER', 'SDLK_KP_GREATER')
register('K_KP_AMPERSAND', 'SDLK_KP_AMPERSAND')
register('K_KP_DBLAMPERSAND', 'SDLK_KP_DBLAMPERSAND')
register('K_KP_VERTICALBAR', 'SDLK_KP_VERTICALBAR')
register('K_KP_DBLVERTICALBAR', 'SDLK_KP_DBLVERTICALBAR')
register('K_KP_COLON', 'SDLK_KP_COLON')
register('K_KP_HASH', 'SDLK_KP_HASH')
register('K_KP_SPACE', 'SDLK_KP_SPACE')
register('K_KP_AT', 'SDLK_KP_AT')
register('K_KP_EXCLAM', 'SDLK_KP_EXCLAM')
register('K_KP_MEMSTORE', 'SDLK_KP_MEMSTORE')
register('K_KP_MEMRECALL', 'SDLK_KP_MEMRECALL')
register('K_KP_MEMCLEAR', 'SDLK_KP_MEMCLEAR')
register('K_KP_MEMADD', 'SDLK_KP_MEMADD')
register('K_KP_MEMSUBTRACT', 'SDLK_KP_MEMSUBTRACT')
register('K_KP_MEMMULTIPLY', 'SDLK_KP_MEMMULTIPLY')
register('K_KP_MEMDIVIDE', 'SDLK_KP_MEMDIVIDE')
register('K_KP_PLUSMINUS', 'SDLK_KP_PLUSMINUS')
register('K_KP_CLEAR', 'SDLK_KP_CLEAR')
register('K_KP_CLEARENTRY', 'SDLK_KP_CLEARENTRY')
register('K_KP_BINARY', 'SDLK_KP_BINARY')
register('K_KP_OCTAL', 'SDLK_KP_OCTAL')
register('K_KP_DECIMAL', 'SDLK_KP_DECIMAL')
register('K_KP_HEXADECIMAL', 'SDLK_KP_HEXADECIMAL')
register('K_LCTRL', 'SDLK_LCTRL')
register('K_LSHIFT', 'SDLK_LSHIFT')
register('K_LALT', 'SDLK_LALT')
register('K_LGUI', 'SDLK_LGUI')
register('K_RCTRL', 'SDLK_RCTRL')
register('K_RSHIFT', 'SDLK_RSHIFT')
register('K_RALT', 'SDLK_RALT')
register('K_RGUI', 'SDLK_RGUI')
register('K_MODE', 'SDLK_MODE')
register('K_AUDIONEXT', 'SDLK_AUDIONEXT')
register('K_AUDIOPREV', 'SDLK_AUDIOPREV')
register('K_AUDIOSTOP', 'SDLK_AUDIOSTOP')
register('K_AUDIOPLAY', 'SDLK_AUDIOPLAY')
register('K_AUDIOMUTE', 'SDLK_AUDIOMUTE')
register('K_MEDIASELECT', 'SDLK_MEDIASELECT')
register('K_WWW', 'SDLK_WWW')
register('K_MAIL', 'SDLK_MAIL')
register('K_CALCULATOR', 'SDLK_CALCULATOR')
register('K_COMPUTER', 'SDLK_COMPUTER')
register('K_AC_SEARCH', 'SDLK_AC_SEARCH')
register('K_AC_HOME', 'SDLK_AC_HOME')
register('K_AC_BACK', 'SDLK_AC_BACK')
register('K_AC_FORWARD', 'SDLK_AC_FORWARD')
register('K_AC_STOP', 'SDLK_AC_STOP')
register('K_AC_REFRESH', 'SDLK_AC_REFRESH')
register('K_AC_BOOKMARKS', 'SDLK_AC_BOOKMARKS')
register('K_BRIGHTNESSDOWN', 'SDLK_BRIGHTNESSDOWN')
register('K_BRIGHTNESSUP', 'SDLK_BRIGHTNESSUP')
register('K_DISPLAYSWITCH', 'SDLK_DISPLAYSWITCH')
register('K_KBDILLUMTOGGLE', 'SDLK_KBDILLUMTOGGLE')
register('K_KBDILLUMDOWN', 'SDLK_KBDILLUMDOWN')
register('K_KBDILLUMUP', 'SDLK_KBDILLUMUP')
register('K_EJECT', 'SDLK_EJECT')
register('K_SLEEP', 'SDLK_SLEEP')
